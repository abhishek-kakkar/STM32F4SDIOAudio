...
CSRC = $(PORTSRC) \
       ...
       main.c user.c FatFSWrapper/fatfs_stream.c FATFSWrapper/fatfsWrapper.c syscalls.c \
       codec_CS43L22.c wavePlayer.c
...
INCDIR = $(PORTINC) $(KERNINC) $(TESTINC) \
         ...
         $(CHIBIOS)/os/various BSP FatFSWrapper
...
ram: build/ch.bin
	...
	@echo
	@arm-none-eabi-size build/ch.hex
