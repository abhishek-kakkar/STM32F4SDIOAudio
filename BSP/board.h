...
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_PIN0, 0) |           \
                                     ...
                                     PIN_AFIO_AF(GPIOB_SWO, 6) |            \
                                     PIN_AFIO_AF(GPIOB_PIN4, 0) |           \
                                     PIN_AFIO_AF(GPIOB_PIN5, 6) |           \
...
#define VAL_GPIOC_AFRH              (PIN_AFIO_AF(GPIOC_PIN8, 12) |           \
                                     PIN_AFIO_AF(GPIOC_PIN9, 12) |           \
                                     PIN_AFIO_AF(GPIOC_SCLK, 12) |           \
                                     PIN_AFIO_AF(GPIOC_PIN11, 12) |          \
                                     PIN_AFIO_AF(GPIOC_SDIN, 12) |           \
...
#define VAL_GPIOD_MODER             (PIN_MODE_ALTERNATE(GPIOD_PIN0) |           \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOD_RESET) |         	\
                                     PIN_MODE_ALTERNATE(GPIOD_OVER_CURRENT) |   \
                                     PIN_MODE_INPUT(GPIOD_PIN6) |           	\
                                     PIN_MODE_ALTERNATE(GPIOD_PIN7) |           \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOD_LED5) |          	\
                                     PIN_MODE_ALTERNATE(GPIOD_LED6))
...
#define VAL_GPIOD_AFRL              (PIN_AFIO_AF(GPIOD_PIN0, 12) |           \
                                     ...
                                     PIN_AFIO_AF(GPIOD_RESET, 12) |          \
                                     PIN_AFIO_AF(GPIOD_OVER_CURRENT, 12) |   \
                                     PIN_AFIO_AF(GPIOD_PIN6, 0) |           \
                                     PIN_AFIO_AF(GPIOD_PIN7, 12))
#define VAL_GPIOD_AFRH              (PIN_AFIO_AF(GPIOD_PIN8, 12) |           \
                                     PIN_AFIO_AF(GPIOD_PIN9, 12) |           \
                                     PIN_AFIO_AF(GPIOD_PIN10, 12) |          \
                                     PIN_AFIO_AF(GPIOD_PIN11, 12) |          \
                                     PIN_AFIO_AF(GPIOD_LED4, 0) |           \
                                     PIN_AFIO_AF(GPIOD_LED3, 0) |           \
                                     PIN_AFIO_AF(GPIOD_LED5, 12) |           \
                                     PIN_AFIO_AF(GPIOD_LED6, 12))
